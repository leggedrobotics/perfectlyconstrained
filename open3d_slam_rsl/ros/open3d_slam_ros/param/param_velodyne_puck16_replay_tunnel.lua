...
params.mapper_localizer.scan_to_map_registration.scan_processing.voxel_size = 0.1 --meters
params.mapper_localizer.scan_to_map_registration.scan_processing.downsampling_ratio = 1.0
params.mapper_localizer.scan_to_map_registration.scan_processing.scan_cropping.cropping_radius_max = 100.0  --meters
params.mapper_localizer.scan_to_map_registration.scan_processing.scan_cropping.cropping_radius_min = 1.0 --meters
...
--MAP_BUILDER
params.map_builder.map_voxel_size = 0.2 --meters
params.map_builder.scan_cropping.cropping_radius_max = 100.0 --meters
params.map_builder.scan_cropping.cropping_radius_min = 1.0 --meters
params.map_builder.space_carving.carve_space_every_n_scans = 10

--DENSE_MAP_BUILDER
params.dense_map_builder.map_voxel_size = 0.05 --meters
params.dense_map_builder.scan_cropping.cropping_radius_max = 105.0 --meters
params.dense_map_builder.space_carving.carve_space_every_n_scans = 10
params.dense_map_builder.space_carving.truncation_distance = 0.1 --meters
